...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $urlRouterProvider.otherwise('/tab/dash');
        ...
        .controller("ExampleController", function($scope, $rootSctope, $ionicPlatform, $cordovaBeacon)) {
            ...
            $cordovaBeacon.startRangingBeaconInRegion($cordovaBeacon.createBeaconRange("estimote", "uuid-nyet-nein"))
